...
const BandSlider = () => {
    ...
    const { currentCaseImage, currentBandImage, size, band, collection, selectedFace, selectedBand } = useSelector(
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center justify-center h-full px-3 sm:px-12">
                                                <button
                                                    className="relative flex items-center justify-center w-full h-full max-w-[calc(100vw-400px)]"
