...
import { Band, variations } from "@/types/watch";
...
const BandSelection = () => {
    ...
    const handleBandClick = (variation: variations, mainBand: Band) => {
        if (isScrolling || isTransitioning) return;
                ...
                <div className="relative h-[53vh] max-h-[508px] min-h-[350px] sm:min-h-[314px] w-full m-auto z-0">
                    {!isSideView && (
                        <motion.div
                            ...
                            exit={{ opacity: 0 }}
                            transition={{ duration: 0.3 }}
                            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 h-full w-full max-w-[350px] md:max-w-[100%] sm:w-[52vh] px-4 sm:px-0"
                        >
                            <Image
                    ...
                    <div className="relative h-full overflow-hidden">
                        {showLeftButton && (
                            <button
                                onClick={(e) =>
                                    !isTransitioning && handleNavigationClick("prev", e)
                                }
                                onTouchStart={(e) =>
                                    !isTransitioning && handleNavigationClick("prev", e)
                                }
                        ...
                        {showRightButton && (
                            <button
                                onClick={(e) =>
                                    !isTransitioning && handleNavigationClick("next", e)
                                }
                                onTouchStart={(e) =>
                                    !isTransitioning && handleNavigationClick("next", e)
                                }
                                        ...
                                        >
                                            <div className="flex items-center justify-center h-full px-3 sm:px-12">
                                                <button
                                                    ...
                                                    onClick={() =>
                                                        !isTransitioning &&
                                                        handleBandClick(variation, currBand!)
                                                    }
